...
This project uses Reinicorn skills in your skills directory (default `.agents/skills/`, configurable via `REINICORN_SKILLS_DIR`). Skills auto-load when your request matches a skill's description, or invoke via slash command (e.g. `/using-reinicorn`, `/populate-agents-md`).
