...
This project uses Reinicorn skills in `.agents/skills/`. Skills auto-load when your request matches a skill's description, or invoke via slash command (e.g. `/using-reinicorn`, `/populate-agents-md`).
